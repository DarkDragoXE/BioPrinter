...
#endif
//
// Extruder Endstop (for syringe homing)
#ifndef E0_MIN_PIN
  #define E0_MIN_PIN                        PG11  // Z2-STOP connector for E0 homing
#endif
//#define I_STOP_PIN                  I_DIAG_PIN  //i-Stop (disabled, using E0_MIN_PIN instead)
...
// deb changes
//#ifndef I_MIN_PIN
  //#define I_MIN_PIN                         PG11  // Z2-STOP connector
//#endif
/*
// I axis shares E0 motor driver (Motor 4)
#ifndef I_STEP_PIN
  #define I_STEP_PIN                        PF9   // E0 STEP
#endif
#ifndef I_DIR_PIN
  #define I_DIR_PIN                         PF10  // E0 DIR
#endif
#ifndef I_ENABLE_PIN
  #define I_ENABLE_PIN                      PG2   // E0 ENABLE
#endif
#ifndef I_CS_PIN
  #define I_CS_PIN                          PF2   // E0 CS for TMC2209
#endif */
//
...
// I axis no longer needed - E0 has native homing support
//#define I_STEP_PIN                         PG4   // MOTOR 3 (same as E0)
//#define I_DIR_PIN                          PC1   // MOTOR 3 (same as E0)
//#define I_ENABLE_PIN                       PA0   // MOTOR 3 (same as E0)
...
// BIOPRINTER: I and J axes for printhead Z height adjustment
// I axis uses Motor 6 (E2 hardware), J axis uses Motor 7 (E3 hardware)
