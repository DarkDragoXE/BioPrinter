...
#define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current
  ...
  #define PID_FUNCTIONAL_RANGE 50 // FIXED: Was 5, causing heater to stop 5°C before target. Now 50 for normal operation.
 ...
 */
//#define PREVENT_COLD_EXTRUSION ///////// deb changes
#define EXTRUDE_MINTEMP 0 ////170 //// deb changes

/**
 * Prevent a single extrusion longer than EXTRUDE_MAXLENGTH.
 * Note: For Bowden Extruders make this large enough to allow load/unload.
 */
//#define PREVENT_LENGTHY_EXTRUDE     ///////////deb changes
#define EXTRUDE_MAXLENGTH 500 /// 200 to 500
...
#define ENDSTOPPULLUPS
  ...
  #define E0_MAX_ENDSTOP_INVERTING false /// deb changes E0 endstop
...
// Manual control of I axis for extruder homing - DISABLED (not used)
//#define I_ENABLE_ON 0
//#define DISABLE_I false /////////////// deb changes
