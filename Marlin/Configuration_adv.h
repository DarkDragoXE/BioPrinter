 ...
 */
   ...
   * below 2.
   */ ///////deb changes temp limit
  #define WATCH_TEMP_PERIOD  50              // Seconds - Increased for slow Peltier heating
...
/**
 * Pneumatic Extruder Control for Bioprinting
 *
 * Converts E1 from stepper motor control to pneumatic dispenser control.
 * The E1_ENABLE_PIN (PC3) acts as a solenoid/valve control signal:
 * - HIGH (3.3V): Valve open, pneumatic pressure dispenses material
 * - LOW (0V): Valve closed, no dispensing
 *
 * Usage:
 * - T0: Selects E0 (syringe-based stepper extruder)
...
/**
 * Peltier Bidirectional Temperature Control for E0
 *
 * Hardware Setup:
 * - ULN2003 driver connected to DPDT relay
 * - MOSFET connected to Peltier power via DPDT
 *
 * Pin Assignments:
 ...
 * Wiring:
 *   PD12 → ULN2003 IN1
 *   ULN2003 OUT1 → DPDT Relay Coil (+)
 *   DPDT Coil (-) → 12V SMPS
 *   PA2 → MOSFET Gate
 *   MOSFET Source → GND
 *   MOSFET Drain → DPDT COM
 *   DPDT NO/NC → Peltier (+/-)
...
//#define PELTIER_CONTROL_BED  // Bed Peltier (DISABLED - use M42 for manual control)
  ...
  // PID tuning for Peltier (different from resistive heaters!)
  // These need to be tuned with M303 for your specific Peltier module
  #define PELTIER_PID_KP  20.0
  #define PELTIER_PID_KI   2.0
  #define PELTIER_PID_KD  10.0
#endif
...
#define INVERT_I_DIR_PIN true  ///// deb changes
/**
 * Idle Stepper Shutdown
 * Set DISABLE_INACTIVE_? 'true' to shut down axis steppers after an idle period.
 * The Deactive Time can be overridden with M18 and M84. Set to 0 for No Timeout.
 */
#define DEFAULT_STEPPER_DEACTIVE_TIME 0  // 0 = No Timeout, motors always stay powered
#define DISABLE_INACTIVE_X false  // Keep motors always powered
#define DISABLE_INACTIVE_Y false
#define DISABLE_INACTIVE_Z false  // Keep Z locked for position accuracy
...
#define DISABLE_INACTIVE_E false  // Keep E motor always powered
...
//#define ENCODER_RATE_MULTIPLIER  // Disabled to prevent accidental super-fast moves on bioprinter
...
#define STARTUP_COMMANDS "M302 S0\nM155 S2"  // M302 S0=allow cold extrusion; M155 S2=auto-report temp for TFT
/**
 * G-code Macros
 *
...
/*#define CUSTOM_MENU_MAIN
  ...
  #define CUSTOM_MENU_MAIN_TITLE "Extruder Controls"
  
  #define MAIN_MENU_ITEM_1_DESC "Home Extruder"
  #define MAIN_MENU_ITEM_1_GCODE "G28 I"

  #define MAIN_MENU_ITEM_2_DESC "Reset E Position"
  #define MAIN_MENU_ITEM_2_GCODE "G92 E0"

  #define MAIN_MENU_ITEM_3_DESC "Home XYZ Only"
  #define MAIN_MENU_ITEM_3_GCODE "G28 X Y Z"
#endif */
#define CUSTOM_MENU_MAIN
#if ENABLED(CUSTOM_MENU_MAIN)
  #define CUSTOM_MENU_MAIN_TITLE "Print Setup"

  // STEP 1: Home extruder to refill position (E0 endstop)
  #define MAIN_MENU_ITEM_1_DESC "1-Home Extruder"
  #define MAIN_MENU_ITEM_1_GCODE "G28 E\nM117 REFILL SYRINGE NOW"

  // STEP 2: After refill, move to full position and set E=0
  #define MAIN_MENU_ITEM_2_DESC "2-Set Full Position"
  #define MAIN_MENU_ITEM_2_GCODE "M302 P1\nG91\nG1 E100 F300\nG90\nG92 E0\nM117 READY"

  // STEP 3: Home XYZ before printing
  #define MAIN_MENU_ITEM_3_DESC "3-Home XYZ"
  #define MAIN_MENU_ITEM_3_GCODE "G28 X Y Z\nM117 Ready to Print"

  // BONUS: Quick home everything
 // #define MAIN_MENU_ITEM_4_DESC "Quick Setup"
 // #define MAIN_MENU_ITEM_4_GCODE "G28 E\nM117 Refill & Click Item 2"
#endif
/*#define CUSTOM_MENU_MAIN
#if ENABLED(CUSTOM_MENU_MAIN)
  #define CUSTOM_MENU_MAIN_TITLE "Extruder Setup"
  
  // Step 1: Check switch status
  #define MAIN_MENU_ITEM_1_DESC "1-Check Switch"
  #define MAIN_MENU_ITEM_1_GCODE "M119\nM117 See switch status"
  
  // Step 2: Retract slowly (repeat until switch hits)
  #define MAIN_MENU_ITEM_2_DESC "2-Retract 5mm"
  #define MAIN_MENU_ITEM_2_GCODE "M302 P1\nG91\nG1 E5 F200\nG90\nM119"
  
  // Step 3: Set as zero
  #define MAIN_MENU_ITEM_3_DESC "3-Set Zero"
  #define MAIN_MENU_ITEM_3_GCODE "G92 E0\nM117 E=0 SET"
  
  // Step 4: Extend to full position
  #define MAIN_MENU_ITEM_4_DESC "4-Extend Full"
  #define MAIN_MENU_ITEM_4_GCODE "M302 P1\nG91\nG1 E-100 F300\nG90\nG92 E0\nM117 READY"
  
  // Step 5: Home XYZ
  #define MAIN_MENU_ITEM_5_DESC "5-Home XYZ"
  #define MAIN_MENU_ITEM_5_GCODE "G28 X Y Z\nM117 Ready"
#endif */
////////deb changes
// Custom Menu: Main Menu
//#define CUSTOM_MENU_MAIN
...
// M42 - Set pin states
//
#define DIRECT_PIN_CONTROL  // ENABLED - Required for M42 P60 Peltier mode control
